...
# fixes inheritance_diagram Popen issue by preimporting subprocess
import soma_workflow.subprocess as subprocess

# If extensions (or modules to document with autodoc) are in another directory,
# add these directories to sys.path here. If the directory is relative to the
# documentation root, use os.path.abspath to make it absolute, like shown here.
sys.path.insert(0, os.path.abspath(os.path.join("..", "..", "python", "soma_workflow")))
#print('path', sys.path)
...
version = soma_workflow.version.shortVersion
# The full version, including alpha/beta/rc tags.
release = soma_workflow.version.fullVersion
...
html_title = "soma-workflow version " + soma_workflow.version.shortVersion + " documentation"
...
# of the sidebar.
html_logo = "images/logo_white_small.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "images/icon_small.ico"
...
htmlhelp_basename = 'soma-workflowdoc'
