...
sys.path.insert(0,os.path.abspath("../../python/soma_workflow/"))
...
extensions = ['sphinxtogithub','sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.coverage', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode']
...
html_title = "soma-workflow developement version documentation"
...
# pixels large.
html_favicon = "images/icon_small.png"
