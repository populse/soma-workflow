...
This package is an implementation of the DRMAA 2.0 Python language
binding specification (https://www.ogf.org/documents/GFD.231.pdf).  See
...
"""
    ...
    # no return value
    def initialize(self, contactString=None):
        """\
...
"""
        self._session = _w.init(contactString)
