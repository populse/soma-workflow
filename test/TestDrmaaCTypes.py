...
class DrmaaCTypesTest(unittest.TestCase):
    ...
    def tearDown(self):
        rmpaths=[]
        rmpaths.append(os.path.join(os.path.expanduser("~"),"soma-workflow-empty-job-patch-torque.o"))
        rmpaths.append(os.path.join(os.path.expanduser("~"),"soma-workflow-empty-job-patch-torque.e"))
...
#        self.checkoutput(sch)
    ...
    def test_DrmaaCTypesSubAJob(self):
        ...
        job = Job( ["echo", "hello jinpeng"],
                 ...
                 os.path.join(sch.tmp_file_path,'soma-workflow-empty-job-patch-torque.o'),
